...
class CGrupoUsuario {
    ...
    public function __construct() {
        ...
        $this->ObjGrupoUsuario = new OGrupoUsuario();
    ...
    public function GetGroupUser($Object) {
        ...
        $Query->bindValue(1, '%' . $this->ObjGrupoUsuario->Nome . '%');
        $Query->execute();
        return $Query->fetchAll();
    }
    
    public function InsertGroupUser($Object) {
